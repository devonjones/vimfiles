...
elseif &background=='dark' 
  ...
  hi Constant		guifg=#9999CC	guibg=NONE	gui=bold
  hi String		guifg=#80c0e0	guibg=NONE	gui=NONE
  hi Boolean		guifg=#9999CC	guibg=NONE	gui=bold
  hi Number		guifg=#e0c060	guibg=NONE	gui=bold
  hi Identifier		guifg=#996666	guibg=NONE	gui=NONE
  hi Function		guifg=#ff9999	guibg=NONE	gui=NONE
  hi Statement		guifg=#c0d8f8	guibg=NONE	gui=NONE
  hi Exception		guifg=#bb4444	guibg=NONE	gui=NONE
  ...
  hi Search		guifg=#000000	guibg=#FFFFCC	gui=NONE
